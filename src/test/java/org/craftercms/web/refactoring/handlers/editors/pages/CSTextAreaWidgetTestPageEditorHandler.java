 ...
 * @author Juan Avila
 */
public abstract class CSTextAreaWidgetTestPageEditorHandler extends CSPageEditorHandler {

    private static final String CONTENT_TYPE = "";

    public CSTextAreaWidgetTestPageEditorHandler(WebDriver webDriver, String siteName) {
